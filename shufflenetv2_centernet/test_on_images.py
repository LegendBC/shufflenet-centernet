...
if test_item=="voc":
    ...
    imgfile_pattern ="E:/Code/vscode/python/shufflenetv2_centernet/tiny_vid/bird/*"
    model_path = "E:/Code/vscode/python/shufflenetv2_centernet/shufflenet-vid/shufflenet-vid.ckpt-200"
    down_ratio = 4.0
