...
if test_item=="voc":
    ...
    imgfile_pattern="E:/study/AI/tiny_vid/tiny_vid/car/*"
    model_path = "E:/study/AI/centernet_tensorflow_wilderface_voc/yolo3_centernet_voc/yolo3_centernet_voc.ckpt-70000"
    down_ratio=8.0
    ...
    class_names=("face",)
    imgfile_pattern ="E:/study/AI/tiny_vid/tiny_vid/car/*"
    model_path = "E:/Code/vscode/python/shufflenetv2_centernet/shufflenet-vid/shufflenet-vid.ckpt-1000"
    down_ratio = 4.0
    ...
    for i in range(num_classes):
        ...
        if use_nms and boxes!=[]:
            ...
            for ind in inds:
                ...
                cv2.circle(src, (center_x_src, center_y_src), 2, (0, 0, 255), 2)
                cv2.rectangle(src, (x1_src, y1_src), (x2_src, y2_src), (0, 255, 0), 1)
    cv2.imwrite("E:/Code/vscode/python/shufflenetv2_centernet/voc_detect.jpg",src)
    cv2.imshow('src', src)
    cv2.waitKey()
